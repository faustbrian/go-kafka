...
[compatibility matrix](compatibility.md) for the tested and lifecycle
boundaries.
...
[transaction guide](transactions.md). Processor observers report the same
...
or support check. See the [configuration reference](configuration.md).
...
[consumer guide](consumer.md) for rollout and close semantics.
...
See the [inspection guide](inspection.md) for authorization, partial-state,
...
See the [specification decision register](specification-decisions.md),
[compatibility matrix](compatibility.md),
[documentation index](README.md), [guarantees](guarantees.md),
[public conformance suites](conformance.md),
[observability](observability.md), [performance evidence](performance.md),
[operations](operations.md), [topic and partition design](topic-design.md),
[operational runbooks](runbooks.md),
[migration and upgrades](migration.md),
[troubleshooting and glossary](troubleshooting.md),
[Amazon MSK and ECS deployment](aws-msk-ecs.md), and
...
[compatibility matrix](compatibility.md). Security reports follow
...
[performance guide](performance.md) for the current capture and remaining
matrix.
