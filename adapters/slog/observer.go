// Package kafkaslog translates bounded Kafka observations into fixed structured
...
var (
	...
	ErrLoggerRequired = errors.New("kafka/slog: logger is required")
	...
	ErrInvalidIdentityPolicy = errors.New(
		"kafka/slog: identity policy is invalid",
	)
	// ErrContextRequired reports a nil observer context.
	ErrContextRequired = errors.New("kafka/slog: context is required")
	// ErrInvalidObservation reports metadata outside the root observation
	// contract.
	ErrInvalidObservation = errors.New("kafka/slog: observation is invalid")
	...
	ErrLoggerPanic = errors.New("kafka/slog: logger panicked")
)
